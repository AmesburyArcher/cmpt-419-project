          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-xs text-gray-500">Data-Centric AI Project</p>
        ...
        <footer className="bg-white border-t mt-12">
          <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-600">
              ...
              <div>
                ...
                <p className="text-xs">
                  ...
                  predictions. Features calibration analysis, Brier scoring, and
            ...
            <div className="mt-6 pt-6 border-t text-center text-xs text-gray-500">
              <p>
                Built with React, TypeScript, TensorFlow.js, and TanStack Query
              </p>
            </div>
          </div>
        </footer>
